...
U-Net cell segmentation on the [DIC-C2DH-HeLa dataset](https://celltrackingchallenge.net/2d-datasets/). I intent to make this my submission for the [Cell Tracking Challenge (CTC)](https://celltrackingchallenge.net/).
...
The original U-Net network architecture<sup>[[1]](https://doi.org/10.1007/978-3-319-24574-4_28)</sup> with an added zero padding step after each convolutional layer was implemented with Tensorflow. The binary cross-entropy loss with the distance-based pixel weight maps described in the original paper has also been implemented. Different data augmentation methods were explored, mainly geometric variations such as rotations, elastic deformation<sup>[[2]](https://doi.org/10.1109/ICDAR.2003.1227801)</sup> and grid distortion<sup>[[3]](https://doi.org/10.3390/info11020125)</sup>. To correct gray value variations and to avoid an extra step of data augmentation, I added a Contrast Limited Adaptive Histogram Equalization (CLAHE)<sup>[[4]](https://doi.org/10.1109/VBC.1990.109340)</sup> pre-processing step using OpenCV. There are no post-processing steps that come after the neural network.
...
[3] Buslaev, A.; Iglovikov, V.I.; Khvedchenya, E.; Parinov, A.; Druzhinin, M.; Kalinin, A.A. Albumentations: Fast and Flexible Image Augmentations. Information 2020, 11, 125. doi.org/10.3390/info11020125
